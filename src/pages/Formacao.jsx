    ...
    <div className="formacao-page">
      ...
      <header className="page-hero">
        <div className="container">
          <div className="page-badge">📚 Minha Trajetória</div>
          <h1 className="page-title">Formação <span className="highlight">Acadêmica</span></h1>
          <p className="page-subtitle">
            Minha jornada de aprendizado em tecnologia e desenvolvimento de software.
          </p>
        </div>
      </header>
      ...
      <section className="formacao-section">
        <div className="container">
          ...
          {/* Timeline */}
          <h2 className="section-label">🎓 Trajetória Educacional</h2>
